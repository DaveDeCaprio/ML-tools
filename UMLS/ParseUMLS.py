...
if __name__ == "__main__":
   ...
   mrconso_file   = open(pjoin(args.rrf_folder, 'MRCONSO.RRF'), 'rt', encoding='UTF-8')
   lines_read     = 0
   ...
   mrdef_file  = open(pjoin(args.rrf_folder, 'MRDEF.RRF'), 'rt', encoding='UTF-8')
   lines_read  = 0
   ...
   mrsty_file  = open(pjoin(args.rrf_folder, 'MRSTY.RRF'), 'rt', encoding='UTF-8')
   lines_read  = 0
   ...
   mrrel_file  = open(pjoin(args.rrf_folder, 'MRREL.RRF'), 'rt', encoding='UTF-8')
   lines_read  = 0
